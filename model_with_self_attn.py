...
F = 32
D = 10
DATA_FILES = ['bicep_train.npz']
MODE = 'LOTO'
BASE_DIR = 'E:\yoga\Yoga-Pose-Classification-and-Skeletonization\CNN_LSTM_ATTN_model\data\LOTO'
SAVE_DIR = 'E:\yoga\Yoga-Pose-Classification-and-Skeletonization\CNN_LSTM_ATTN_model\model_with_self_attn_LOTO_results'
